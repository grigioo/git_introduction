...
В качестве параметров, идущих на выход *git log* мы получаем информаи=цию об автор комиита, комментарии к нему, идентификатору по хэшу, а также дате, когда он был 
